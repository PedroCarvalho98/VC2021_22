...
right = cv2.imread('#Lab5and6Images/right01.jpg')
...
cv2.stereoRectify(intrinsics1, distortion1, intrinsics2, distortion2, (width,height), R, T, 0)
image_3d = cv2.reprojectImageTo3D(disparity, Q)

np.savez('3Dcoordinates.npz', image_3d = image_3d)
